...
@section('content')
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <form action="{{ route('membro.store') }}" method="POST" data-parsley-validate="true" name="form-wizard">
                <div id="wizard">
                    <ol>
                        <li>
                            Informações
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" id="div_nascimento">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" name="nascimento" class="form-control" id="nascimento" placeholder="23/12/2017"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="end_numero" id="numero" placeholder="100"
                                                   class="form-control" data-parsley-group="wizard-step-3" required/>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div>
                        <div class="jumbotron m-b-0 text-center">
                            <div class="row">
                                ...
                                <p style="padding-left: 30%;"><button class="btn btn-success btn-lg" type="submit" role="button">Salvar Membro</button></p>
                                </div>
